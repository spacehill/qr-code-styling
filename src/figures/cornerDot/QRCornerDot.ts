...
export default class QRCornerDot {
  ...
  _basicDot(args: BasicFigureDrawArgs): void {
    ...
    this._rotateFigure({
      ...args,
      draw: () => {
        const circle = this._window.document.createElementNS(
  ...
  _basicSquare(args: BasicFigureDrawArgs): void {
    ...
    this._rotateFigure({
      ...args,
      draw: () => {
        const rect = this._window.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "rect"
        );
  ...
  _basicRoundedSquareRightBottomEdge(args: BasicFigureDrawArgs): void {
    ...
    this._rotateFigure({
      ...
      draw: () => {
        ...
        const flatCornerRect = this._window.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "rect"
        );
  ...
  _basicDiamond(args: BasicFigureDrawArgs): void {
    ...
    this._rotateFigure({
      ...args,
      draw: () => {
        const polygon = this._window.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "polygon"
        );
  ...
  _basicPlus(args: BasicFigureDrawArgs): void {
    ...
    this._rotateFigure({
      ...args,
      draw: () => {
        const group = this._window.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "g"
        );

        const verticalRect = this._window.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "rect"
        );
        ...
        const horizontalRect = this._window.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "rect"
        );
  ...
  _basicRhombus(args: BasicFigureDrawArgs): void {
    ...
    this._rotateFigure({
      ...
      draw: () => {
        ...
        const verticalTopTriangle = this._window.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "polygon"
        );
        ...
        const verticalBottomTriangle = this._window.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "polygon"
        );
        ...
        const horizontalLeftTriangle = this._window.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "polygon"
        );
        ...
        const horizontalRightTriangle = this._window.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "polygon"
        );
